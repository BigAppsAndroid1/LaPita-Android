...
import il.co.lapita.data.ListType
...
import il.co.lapita.infrastructure.Locator.notifications
import il.co.lapita.infrastructure.Locator.repository
import il.co.lapita.infrastructure.foregroundFragment
import il.co.lapita.notifications.NotificationSubscribeDialog
import il.co.lapita.utilities.OnSwipeTouchListener
...
class ProductListFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.subCategory.observe({ lifecycle }) { subCategory ->
    ...
    private fun initNotifications() {
        ...
        else if (!Database.isNotShownForSession) {
            NotificationSubscribeDialog.open()
            Database.isNotShownForSession = true
        }
    }

    @SuppressLint("NotifyDataSetChanged")
    private fun observeCartProducts() {
        products.observe({ lifecycle }) { _ ->
