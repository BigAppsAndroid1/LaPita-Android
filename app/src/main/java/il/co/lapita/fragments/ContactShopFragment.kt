...
import il.co.lapita.utilities.dial
import il.co.lapita.utilities.link
...
class ContactShopFragment : BaseFragment() {
    ...
    private fun setToolbar() {
        ...
        menuBar?.setFragmentTitle(getString(R.string.contact))
    }
    ...
    private fun initDetails() {
        ...
        days?.text = shop.workingTimes.joinToString("\n") { il.co.lapita.utilities.getString(R.string.day)+" "+it.dayLocalized() }
