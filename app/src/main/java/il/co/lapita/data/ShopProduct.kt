...
data class ShopProduct(
    ...
    val shopBaseToppings: List<ShopTopping>?,
    val shopProductOptions: List<ShopTopping>?,
    val shopProductsAssociatedIds: List<Int>?
) {
    ...
    val isOptions: Boolean get() = shopProductOptions?.isNotEmpty() == true
    val isBaseToppings: Boolean get() = shopBaseToppings?.isNotEmpty() == true
}
...
data class BaseProduct(
    ...
    val baseToppingsDescription: String?,
