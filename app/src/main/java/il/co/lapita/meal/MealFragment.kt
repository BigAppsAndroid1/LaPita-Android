...
class MealFragment : BaseFragment() {
    ...
    private val mealCallback: ((
        ...
        MutableList<MutableList<Pair<Int, List<Int>>>>?,
        MutableList<MutableList<Pair<Int, List<Int>>>>?
    ) -> Unit) = { product, amount, baseToppings, toppings, options ->
        addItemToMeal(product, amount, baseToppings, toppings, options)

    }
    private var level: Int? = null

    private var onComplete: ((ShopProduct, Float?, MutableList<MutableList<Pair<Int, List<Int>>>>?, MutableList<MutableList<Pair<Int, List<Int>>>>?, MutableList<MutableList<Pair<Int, List<Int>>>>?) -> Unit)? =
        null
    ...
    override fun onArguments(arguments: Map<String, Any?>) {
        ...
        (arguments[KEY_ON_COMPLETE] as? ((ShopProduct, Float?, MutableList<MutableList<Pair<Int, List<Int>>>>?, MutableList<MutableList<Pair<Int, List<Int>>>>?, MutableList<MutableList<Pair<Int, List<Int>>>>?) -> Unit))?.let {
            onComplete = it
        }
    }
